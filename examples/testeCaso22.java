...
public class testeCaso22 {
	...
	public static void main(String[] args) {
		...
		int[] horariosPIBIC = {6,7,7,9,11};
		int[] horariosEstagio = {};
		//int[] horariosTrabalho = {8,8,2,4,12,2};
		int[] horariosTrabalho = {1,0,0,2,0,8};
		...
		descanso.add(new Descanso("Descanso",2,4));
		descanso.add(new Descanso("Descanso",3,3));
		descanso.add(new Descanso("Descanso",4,16));
