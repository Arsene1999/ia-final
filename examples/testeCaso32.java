...
public class testeCaso32 {
	...
	public static void main(String[] args) {
		...
		int[] horariosPIBIC = {7,8,8,7,10};
		int[] horariosEstagio = {};
		//int[] horariosTrabalho = {8,8,2,4,12,2};
		int[] horariosTrabalho = {0,0,0,0,0,0};
		...
		blocos.add(new BlocoDeEstudo("COMP0415",1));
		blocos.add(new BlocoDeEstudo("COMP0409",1));
		blocos.add(new BlocoDeEstudo("COMP0417",1));
		blocos.add(new BlocoDeEstudo("ELET0043",1));
